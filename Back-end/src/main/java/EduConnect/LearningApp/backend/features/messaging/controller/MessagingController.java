package EduConnect.LearningApp.backend.features.messaging.controller;
...
import EduConnect.LearningApp.backend.features.messaging.dto.MessageDto;
...
import EduConnect.LearningApp.backend.features.messaging.service.MessagingService;
import org.springframework.web.bind.annotation.*;

import java.util.List;

@RestController
@RequestMapping("/api/v1/messag")
